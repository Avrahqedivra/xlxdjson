...
cookieSettingsName = window.location.hostname+"_xlxdjson_settings";
settingsValidity = 5;	    // 5 days
settings = [ { config: { "theme": "theme-dark", hidetg: false } }, { "map": { "zoom" : 6.5 } }], { "open": true };
...
/*
function getBand(prefix) {
	if (prefix.startsWith('REF') || prefix.startsWith('XRF')) {		
		switch(prefix.substr(0, 3)) {
			case 'REF'  : return 'REF-Link'; break;
			case 'XRF'  : return 'XRF-Link'; break;
		}
	}
	else {
		switch (prefix[0]) {
				case 'A' : return '23cm'; break;
				case 'B' : return '70cm'; break;
				case 'C' : return '2m'; break;
				case 'D' : return 'Dongle'; break;
				case 'G' : return 'Internet-Gateway'; break;
				default  : return '';
		}
	}
}
